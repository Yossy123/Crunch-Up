...
const CartItem = ({ item }) => {
  ...
  return (
    <div className="flex items-center space-x-3 p-3 bg-slate-50 hover:bg-slate-100/70 rounded-2xl border border-slate-200/60 transition-colors">
      ...
      <div className="flex-1 min-w-0">
        ...
        <h4 className="text-xs sm:text-sm font-semibold text-slate-800 truncate mb-1">
          {product.name}
        </h4>
      ...
      <div className="flex flex-col items-end space-y-2 shrink-0">
        ...
        {/* Quantity Stepper */}
        <div className="flex items-center space-x-1.5 bg-white border border-slate-200 rounded-xl px-1 py-0.5 shadow-2xs">
          <button
